...
public class VerificarPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  setContentView(R.layout.activity_verificar_password);
        ...
        ActivityVerificarPasswordBinding _bindingPassword = DataBindingUtil.setContentView(this,R.layout.activity_verificar_password);
        _bindingPassword.setPasswordModel(new LoginViewModel(this,null,_bindingPassword));
    ...
    //este metodo me ayuda a volver de actividad
    @Override
